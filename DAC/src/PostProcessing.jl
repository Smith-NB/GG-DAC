...
"""
function getSimsAndEnergies(clusterVector::Any, refCNA::CNAProfile)
...
getSimsAndEnergies(clusterVector::String, refCNA::String) = getSimsAndEnergies(jldopen(clusterVector)["clusterVector"], stringToCNA(getCNA(refCNA)))
